...
Route::group([
    'middleware' => 'auth' //enable this middleware in production server
],function() {
...
// locale Route
    ...
    Route::get('/fir-list', [GeneralController::class, 'index'])->name('admin.fir.index');
    Route::get('/fir-list/{id}/form-detail-b', [GeneralController::class, 'formDetailB'])->name('admin.fir.form-detail-b');
    Route::get('/fir-list/{id}/form-detail-c', [GeneralController::class, 'formDetailC'])->name('admin.fir.form-detail-c');
    Route::get('/fir-list/{id}/form-detail-d', [GeneralController::class, 'formDetailD'])->name('admin.fir.form-detail-d');
