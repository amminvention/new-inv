...
<div class="navbar-container d-flex content">
  <div class="bookmark-wrapper d-flex align-items-center">
    <ul class="nav navbar-nav d-xl-none">
      <li class="nav-item"><a class="nav-link menu-toggle" href="javascript:void(0);"><i class="ficon feather icon-menu"></i></a>
      </li>
    </ul>
      <b><i style='font-size: 18px' class='fas fa-crosshairs'></i> &nbsp;Investigation Monitoring System</b>
  </div>
  <ul class="nav navbar-nav align-items-center ms-auto">
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <span class="avatar">
          <img class="round"
            src="{{ asset('images/portrait/small/avatar.png') }}"
