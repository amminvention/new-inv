...
@section('title', 'Investigation Monitoring System')
  ...
  <div class="row match-height">
      ...
      <div class="card card-statistics">
        <div class="card-header">
          ...
          <div class="d-flex align-items-center">
            <p class="card-text font-small-2 me-25 mb-0">{{ \Carbon\Carbon::now()->diffForHumans() }}</p>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">{{ $data['total_cases'] }}</h4>
                  <p class="card-text font-small-3 mb-0">Total Cases</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
    ...
    <div class="row" id="basic-table">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">10 Latest Cases</h4>
                </div>
                <div class="card-body">
{{--                    <p class="card-text">--}}
                        ...
                        @foreach($data['fir'] as $key => $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {!! preg_replace('/[\x{0600}-\x{06FF}]+/u', '<span class="urdu">$0</span>', $data->other_officer) !!}
                                    @elseif ($data->fir_current_io_id > 0)
                                    {!! preg_replace('/[\x{0600}-\x{06FF}]+/u', '<span class="urdu">$0</span>', $data->investigationOfficer->employee->pe_name) . " " . $data->investigationOfficer->employee->rank->rank_name_en !!}
                                    @endif
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('admin.fir.show-form-detail', ['id' => $data->fir_id, 'type' => 1]) }}">
                                                <i data-feather="edit-2" class="me-50"></i>
                                                <span>Edit</span>
                                            </a>
                                            <a class="dropdown-item" href="{{ route('admin.fir.form-detail-b', $data->fir_id) }}">
